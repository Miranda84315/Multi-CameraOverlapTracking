function [ reconnect_trajectories ] = reconnectTrajectories_segment(new_trajectories)
...
for i= 1:length(new_trajectories)
    endFrame = [endFrame; new_trajectories(i).segmentEnd];
    startFrame = [startFrame; new_trajectories(i).segmentStart];
end
