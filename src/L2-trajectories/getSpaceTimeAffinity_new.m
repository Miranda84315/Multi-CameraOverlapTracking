function [stAffinity, impossibilityMatrix, indiffMatrix] = getSpaceTimeAffinity_new(tracklets, beta1, speedLimit, indifferenceLimit)

%{
tracklets=tracklets(indices);
beta1=params.beta;
speedLimit=params.speed_limit;
indifferenceLimit = params.indifference_time;
%}
...
stAffinity      = 1 ./ (1 + distanceMatrix/100 );
