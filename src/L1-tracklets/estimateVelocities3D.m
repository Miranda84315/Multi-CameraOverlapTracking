function estimatedVelocities = estimateVelocities3D(originalDetections, startFrame, endFrame, nearestNeighbors, speedLimit)
...
searchRangeCenters = originalDetections(searchRangeMask, 2:3);
